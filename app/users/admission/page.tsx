...
export default function AdmissionPage() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      let description = "Could not register student.";
  ...
  return (
    <div className="space-y-6">
      <Toaster />
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Admission</h2>
        <p className="text-muted-foreground">
          Please fill all required fields step by step for new admission.
        </p>
      </div>
      <Card>
          ...
          <Tabs value={tab} onValueChange={setTab} className="w-full">
            ...
            <TabsContent value="personal" className="pt-4">
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <Field label="Date of Birth" required className="md:col-span-2">
                  <Input
                    type="date"
              ...
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <Field label="Grandfather Name" required>
                  <Input
                    ...
                    onChange={(e) =>
                      updateGuardian("grandfatherName", e.target.value)
                    }
                  />
                </Field>
                <Field label="Grandmother Name">
                  <Input
                    ...
                    onChange={(e) =>
                      updateGuardian("grandmotherName", e.target.value)
                    }
                  />
                </Field>
                <Field label="Guardian Name" required>
                  <Input
                    ...
                    onChange={(e) =>
                      updateGuardian("guardianName", e.target.value)
                    }
                  />
                </Field>
                <Field label="Guardian Contact" required>
                  <Input
                    ...
                    onChange={(e) =>
                      updateGuardian("guardianContact", e.target.value)
                    }
                  />
                </Field>
                <Field label="Father Number" required>
                  <Input
                    ...
                    onChange={(e) =>
                      updateGuardian("fatherNumber", e.target.value)
                    }
                  />
                </Field>
                <Field label="Mother Number" required>
                  <Input
                    ...
                    onChange={(e) =>
                      updateGuardian("motherNumber", e.target.value)
                    }
                  />
                </Field>
                <Field label="Emergency Contact" required>
                  <Input
                    ...
                    onChange={(e) =>
                      updateGuardian("emergencyContact", e.target.value)
                    }
                  />
                </Field>
              </div>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  <Field label="Province (State)" required>
                    <select
                      ...
                      onChange={(e) =>
                        updateAddress("permanentState", e.target.value)
                      }
                    >
                  ...
                  <Field label="District (City)" required>
                    <select
                      ...
                      onChange={(e) =>
                        updateAddress("permanentCity", e.target.value)
                      }
                    >
                  ...
                  <Field label="Local Government (Municipality)" required>
                    <select
                      ...
                      onChange={(e) =>
                        updateAddress("permanentLocalGovernment", e.target.value)
                      }
                    >
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <Field label="Province (State)" required>
                    <select
                      ...
                      onChange={(e) =>
                        updateAddress("tempState", e.target.value)
                      }
                    >
                      <option value="">Select Province</option>
                      {provinces.map((p) => (
                  ...
                  <Field label="District (City)" required>
                    <select
                      ...
                      onChange={(e) =>
                        updateAddress("tempCity", e.target.value)
                      }
                    >
                      <option value="">Select District</option>
                      {tempDistricts.map((d) => (
                  ...
                  <Field label="Local Government (Municipality)" required>
                    <select
                      ...
                      onChange={(e) =>
                        updateAddress("tempLocalGovernment", e.target.value)
                      }
                    >
                      <option value="">Select Municipality</option>
              ...
              <div className="grid gap-6">
                <Field label="Admission Type" required>
                  <select
                    ...
                    onChange={(e) =>
                      updateDocs("admissionType", e.target.value as "new" | "transferred")
                    }
                  >
