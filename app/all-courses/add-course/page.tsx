...
export default function AddCourse() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Validate image type if image is present
        if (image) {
        ...
        try {
            ...
            if (data.success && data.data && data.data.id) {
                toast({ title: "Success", description: "Course added successfully!", variant:'success' });
                setTitle(""); setDescription(""); setDuration(""); setDepartmentId(""); setImage(null); setCoverImage(null);
                router.push(`/all-courses/add-course/${data.data.id}`);
            }
        } catch (err: unknown) {
    ...
    return (
        <div className="space-y-4">
            <div>
                <h2 className="text-2xl font-bold tracking-tight">Add Course Page</h2>
                <p>This is the add course page.</p>
            </div>
